...
class Datacuti extends CI_Controller {
	...
	{
		$x['data_cuti']=$this->m_cuti->get_datacuti()->result_array();
		$this->load->view('backend/header',$x);
		$this->load->view('backend/datacuti',$x);
	...
	{           $id = $this->input->post('id_pegawai');
                ...
                $tglsls = $this->input->post('tanggal_selesai');
                $jarak = $tglsls->diff($tglmulai);
