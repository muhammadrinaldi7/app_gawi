        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><b>LIHAT LOKASI ABSEN MASUK</b> </h2>
                  ...
                  <div class="x_content">
                    ...
                    <div class="row" >
                      <iframe src="https://maps.google.com/maps?q=<?php echo $data['lat_masuk'];?>,<?php echo $data['long_masuk'];?>&hl=en&z=14&amp;output=embed" width="100%" height="400" frameborder="0" style="border:0" allowfullscreen></iframe> 
                    </div>
